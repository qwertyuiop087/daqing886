...
def heb(m):
    ...
    if u['balance']<fee:
        ...
        return
    safe_send_msg(m.chat.id,f"✅余额校验通过，总行数：{ls}行，正在生成合并文件...")
    if u['mode']=="VCF":
        vcf_all = ""
